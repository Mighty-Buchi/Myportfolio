  ...
  return (
    <div className='bg-gray-100'>
      <motion.div
        ...
        className='grid grid-cols-1 md:grid-cols-2 gap-4   p-5 justify-center  max-w-7xl m-auto'>
        <motion.div
          className="flex flex-col bg-white rounded-2xl border border-white justify-center items-center gap-25 shadow-sm">
        ...
        <motion.div
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, translateY: 0 }}
            transition={{ duration: 1, delay: 0.2 }}
            className='flex flex-col bg-white border border-white shadow-sm rounded-2xl p-4'>
